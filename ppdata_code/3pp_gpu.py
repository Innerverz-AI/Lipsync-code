...
if __name__ == '__main__':
    ...
    for i in tqdm(range(args.pp_num)):
        ...
        dataloader = get_batch_dataloader(img_paths, lmk_paths, dict_paths, batch_size=args.batch_size, img_size=args.image_size, num_worker=args.num_worker)
        for batch_idx, batch in enumerate(dataloader):
            ...
            # optimization
            optimized_code_dict = DC.optimize_per_batch(code_dict, insight_lmks, image_dict['tform_inv'], num_iter=args.num_iter, lmk_type='3D')
