...
def divide_datasets(model, CONFIG):
    gt_img_path_list = sorted(utils.get_all_images(CONFIG['DATASET']['TRAIN_PATH']['GT_IMG']))
    opt_img_path_list = sorted(utils.get_all_images(CONFIG['DATASET']['TRAIN_PATH']['OPT_IMG']))
    train_gt_img_path_list, valid_gt_img_path_list = utils.split_dataset(gt_img_path_list, CONFIG['BASE']['VAL_SIZE'])
    train_opt_img_path_list, valid_opt_img_path_list = utils.split_dataset(opt_img_path_list, CONFIG['BASE']['VAL_SIZE'])
